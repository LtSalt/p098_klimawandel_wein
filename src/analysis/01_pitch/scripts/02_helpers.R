...
cells_europe <- read_sf(here("src/data/processed/pitch/cells_europe/cells_europe.shp"))
cells_germany <- read_sf(here("src/data/processed/pitch/cells_germany/cells_germany.shp"))
