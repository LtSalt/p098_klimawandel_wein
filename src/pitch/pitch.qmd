...
source(here("src/pitch/scripts/01_crop.R")) # precalculates cropped grid cells, matching the outline of europe/germany
source(here("src/pitch/scripts/02_helpers.R")) # small helpers for wrangling and plotting
```
...
#   1. checking if suitability is equal to or greater than the cutoff value
